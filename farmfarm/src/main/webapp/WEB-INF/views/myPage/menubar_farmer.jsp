				...
				<div class="menu">
					...
					<div class="menu_cate">
						...
						<div class="auto-group-3tvm-62R">
							<button class="menuBtn" onclick="location.href='projectList'">
								<div class="chat-eEH">
				...
				<div class="auto-group-sfjb-WBF">
					<div class="mydata-xUm">
						<div class="auto-group-v7t1-s5w">
							...
							<button onclick="location.href='projectList'"
						...
						<div class="info2-hY9">
							...
							<div class="item-123--re1">
								<span class="p-EwP-sub-0">0</span> <span
									class="p-EwP-sub-1"> </span> <span class="item-123--re1-sub-1">P</span>
							</div>
						</div>
						<div class="info3-gwo">
							<img class="auto-group-mtnh-Q1K"
...
window.onload = ()=>{
	const $counter_cart = document.querySelector('.item-123--re1-sub-0');
	const $counter_money = document.querySelector('.p-EwP-sub-0');
	const $counter_supporter = document.querySelector('.item-56--CYm-sub-0');
	const max_cart = 123;
	const max_money = 115320;
	const max_supporter = 56;
