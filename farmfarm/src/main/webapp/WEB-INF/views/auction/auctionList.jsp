			...
			<div class="group-156-QXX">
				<div class="search">
					<input id="searchInput" type="text"
						placeholder="관심있는 농작물 또는 경매 정보를 찾아보세요">
					<button
