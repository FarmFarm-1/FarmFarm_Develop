		...
		<c:forEach items="${depositList}" var="deposit" varStatus="status">
			<div class="content_detailall">
				...
				<div class="content_detail_firstAll">
					...
					<div class="content_detail_second">${deposit.farm_name }</div>
				...
				<div class="content_detail">${deposit.update_date }</div>
				<div class="content_detail">신한 11-1234-5678</div>
				<div class="content_detail2">￦
					<fmt:formatNumber value="${deposit.amount}"
						pattern="#,###" />
				</div>
			</div>
		</c:forEach>
