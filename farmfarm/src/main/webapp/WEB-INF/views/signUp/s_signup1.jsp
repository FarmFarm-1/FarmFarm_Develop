				...
				<div class="auto-group-pxyy-6gM">
					...
					<div class="rectangle-89-e5b">
						...
						<div class="group-103-H7s1">
							...
							<p class="item--sW5">전체 약관동의</p>
						</div>

						<div class="group-103-H7s">
							<input type="checkbox" id="checkbox2" class="checkbox2">
							<p class="item--iys">개인정보 수집 및 이용
								동의(필수)</p> <p onclick="showFullText('terms1')" class="item--Qrh">전문
								보기</p>
						</div>

						<div class="group-104-XAd">
							<input type="checkbox" id="checkbox3" class="checkbox3">
							<p class="item--YLd">팜팜 이용약관(필수)</p> <p onclick="showFullText('sterms2')" class="item--2Wh">전문
								보기</p>
						</div>

						<div class="group-105-jR7">
							<input type="checkbox" id="checkbox4" class="checkbox4">
							<p class="item--NU5">팜팜의 소식과 다양한
								안내(선택)</p> <p onclick="showFullText('terms3')" class="item--GZT">전문
								보기</p>
						</div>
