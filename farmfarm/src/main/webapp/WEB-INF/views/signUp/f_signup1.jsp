					...
					<div class="rectangle-89-e5b">
						...
						<div class="group-103-H7s">
							...
							<label for="checkbox2" class="item--iys">개인정보 수집 및 이용
								동의(필수)</label> <p onclick="showFullText('terms1')" class="item--Qrh">전문
								보기</p>
						</div>

						<div class="group-104-XAd">
							<input type="checkbox" id="checkbox3" class="checkbox3">
							<label for="checkbox3" class="item--YLd">팜팜 이용약관(필수)</label> <p onclick="showFullText('sterms2')" class="item--2Wh">전문
								보기</p>
						</div>
						...
						<div class="group-105-jR7">
							...
							<label for="checkbox4" class="item--NU5">팜팜의 소식과 다양한
								안내(선택)</label> <p onclick="showFullText('terms3')" class="item--GZT">전문
								보기</p>
						</div>
