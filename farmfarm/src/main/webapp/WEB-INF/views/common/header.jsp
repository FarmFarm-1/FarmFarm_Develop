			...
			<div class="header_main">
				<div class="header_title_menu">
					<div class="header_title">
						<a onclick="location.href='main.do'"> <img class="logo_img"
					...
					<div class="header_menu">
						<div class="menu_funding">
							<a id="menu_funding" onclick="location.href='fundingMain'">펀딩</a>
						</div>
						<div class="menu_auction">
							<a id="menu_auction" onclick="location.href='auctionMain'">경매</a>
						</div>
						<div class="menu_myFarm">
							<a id="menu_myFarm" onclick="location.href='projectList'">마이팜</a>
						</div>
					</div>
				</div>

				<div class="header_join_login" id="header_join_login">
					<a onclick="location.href='signup.do'">회원가입&nbsp;</a> <a
						onclick="location.href='login.do'">로그인</a>
				</div>

				<div class="header_user_login" id="header_user_login">
					<div class="messageBox_div" onclick="location.href='messageBox.do'">
					...
					<div class="userPoint_div"
						onclick="location.href='chargePoints.do'">
				...
				<div class="header_farmer_login" id="header_farmer_login">
					<div class="messageBox_div2"
						onclick="location.href='messageBox.do'">
						<img class="messageBox_img2" src="./assets/messageBox.png">
					...
					<div class="myProject" onclick="location.href='makeProject.do'">나의
						프로젝트 만들기</div>
				</div>
			</div>
